...
export default function CompactTypographyInput(props) {
  ...
  }, [defaultTypography.fontFamily, defaultTypography.fontSize, defaultTypography.fontWeight, fontFamily, fontSize, fontWeight, onChange, readOnly])
